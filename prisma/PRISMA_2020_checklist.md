...
| 23b | Discuss any limitations of the evidence included in the review. | `manuscript/manuscript.md` §4.6 | Five enumerated limitations including small-sample fMRI base, single-lab concentration, outcome heterogeneity, k=8 underpower for moderators, English-only inclusion. |
